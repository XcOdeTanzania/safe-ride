...
//                                showInSnackBar('Password too Short');
//                                return;
//                              }
                              //print('Matchess');
                              model.register(email: emailController.text,password: passwordController.text).then((Map<String,dynamic> response){
                                if(response['success']) showInSnackBar('Signin Successfuly');
                                else showInSnackBar('Couldn\'t create Account: ${response['message']}');
                              });
                            }else{
